  ...
  function importScript(src, libName) {
    ...
    w.adthrive.deployment = "2026-01-07-03:pe-512:pr7551:ed3cf34:4";
    w.adthrive.branch = "ed3cf34";
    w.adthrive.bucket = "flex-67";
    w.adthrive.baseUrl = "https://ads.adthrive.com/builds/core/ed3cf34";
