  ...
  function importScript(src, libName) {
    ...
    w.adthrive.deployment = "2026-01-07-03:pe-188:pr7555:a9c9bd1:4";
    w.adthrive.branch = "a9c9bd1";
    w.adthrive.bucket = "flex-50";
    w.adthrive.baseUrl = "https://ads.adthrive.com/builds/core/a9c9bd1";
